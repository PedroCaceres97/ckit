#ifndef __CKIT_FORMAT_H__
#define __CKIT_FORMAT_H__
...
#define boolstr_out(dest, value) strcpy(dest, TERNARY(!!(value), "True", "False"))
#define ynboolstr_out(dest, value) strcpy(dest, TERNARY(!!(value), "Yes", "No"))
...
const char* bytesstr(size_t value); // 1024 -> "1 KB"
#define boolstr(value) TERNARY(!!(value), "True", "False")
#define ynboolstr(value) TERNARY(!!(value), "Yes", "No")

#endif /* __CKIT_FORMAT_H__ */